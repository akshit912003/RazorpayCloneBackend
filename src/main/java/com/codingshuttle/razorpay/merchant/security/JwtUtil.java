...
public class JwtUtil {
    ...
    public String extractRole(Claims claim){ return claim.get("role", String.class);}
    public String extractMerchantId(Claims claim){ return claim.get("merchant_id",String.class);}
